...
class TeacherMicroservice {
    ...
    private fun subscribeToHearbeat() {
        try {
            ...
            heartbeatSocket.getOutputStream().write("problema2_teacher_1~$TEACHER_PORT~problema2_teacher~problema2_default\n".toByteArray())
        ...
        thread {
            ...
            while (true){
                ...
                if(heartbeatBufferReader.readLine() == "heartbeat")
                    heartbeatSocket.getOutputStream().write("teacher_here\n".toByteArray())
            }
        }
