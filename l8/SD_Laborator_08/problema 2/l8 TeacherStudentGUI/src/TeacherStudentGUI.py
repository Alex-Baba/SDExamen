...
def ask_question():
    ...
    threading.Thread(target=resolve_question, args=(f'intrebare {question_text}',)).start()


def get_averages():
    threading.Thread(target=resolve_question, args=('medii_vreau medii',)).start()
...
if __name__ == '__main__':
    ...
    medii = ttk.Button(content, text="Medii", command=get_averages)
