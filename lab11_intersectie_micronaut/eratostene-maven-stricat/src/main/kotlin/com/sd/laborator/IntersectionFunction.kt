...
class IntersectionFunction : FunctionInitializer(), Supplier<IntersectionResponse> {
    @Inject
    ...
    private val LOG: Logger = LoggerFactory.getLogger(IntersectionFunction::class.java)
